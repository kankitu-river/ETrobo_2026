...
static STK_T _kernel_stack_APP_INIT_TASK[COUNT_STK_T(4096)];
static STK_T _kernel_stack_APP_SYNC_TASK[COUNT_STK_T(4096)];
...
static STK_T _kernel_stack_LINE_TRACER_TASK[COUNT_STK_T(STACK_SIZE)];
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(_app_init_task), INT_PRIORITY(TPRI_APP_INIT_TASK), {	(void *)(_kernel_stack_APP_INIT_TASK), 	((void *)((char *)(_kernel_stack_APP_INIT_TASK) + (ROUND_STK_T(4096)))), }, },
	{ (TA_ACT), (EXINF)(0), (TASK)(_app_sync_task), INT_PRIORITY(TPRI_APP_SYNC_TASK), {	(void *)(_kernel_stack_APP_SYNC_TASK), 	((void *)((char *)(_kernel_stack_APP_SYNC_TASK) + (ROUND_STK_T(4096)))), }, },
	{ (TA_ACT), (EXINF)(&tTask_INIB_tab[0]), (TASK)(tTask_start), INT_PRIORITY(4), {	(void *)(_kernel_stack_TSKID_tTask_LogTask_Task), 	((void *)((char *)(_kernel_stack_TSKID_tTask_LogTask_Task) + (ROUND_STK_T(4096)))), }, },
	{ (TA_ACT), (EXINF)(0), (TASK)(main_task), INT_PRIORITY(MAIN_PRIORITY), {	(void *)(_kernel_stack_MAIN_TASK), 	((void *)((char *)(_kernel_stack_MAIN_TASK) + (ROUND_STK_T(STACK_SIZE)))), }, },
	{ (TA_NULL), (EXINF)(0), (TASK)(tracer_task), INT_PRIORITY(TRACER_PRIORITY), {	(void *)(_kernel_stack_LINE_TRACER_TASK), 	((void *)((char *)(_kernel_stack_LINE_TRACER_TASK) + (ROUND_STK_T(STACK_SIZE)))), }, }
};

TCB _kernel_tcb_table[TNUM_TSKID];

const ID _kernel_torder_table[TNUM_TSKID] = { 
	PYBRICKS_TASK, APP_INIT_TASK, APP_SYNC_TASK, TSKID_tTask_LogTask_Task, MAIN_TASK, LINE_TRACER_TASK
};
...
static void
_kernel_cychdr_LINE_TRACER_TASK_CYC(EXINF exinf)
{
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	...
	{ (TA_NULL), (intptr_t)(LINE_TRACER_TASK), _kernel_cychdr_LINE_TRACER_TASK_CYC, (LINE_TRACER_PERIOD), (0) }
};
...
#define TNUM_DEF_INHNO	23
const uint_t _kernel_tnum_def_inhno = TNUM_DEF_INHNO;

INTHDR_ENTRY(INHNO_TIMER, 15, target_hrt_handler)
INTHDR_ENTRY(INHNO_DMA1_STREAM3, 30, DMA1_Stream3_IRQHandler)
INTHDR_ENTRY(INHNO_DMA1_STREAM4, 31, DMA1_Stream4_IRQHandler)
...
INTHDR_ENTRY(INHNO_EXTI4, 26, EXTI4_IRQHandler)
...
const INHINIB _kernel_inhinib_table[TNUM_DEF_INHNO] = {
	...
	{ (INHNO_DMA1_STREAM3), (TA_NULL), (FP)(INT_ENTRY(INHNO_DMA1_STREAM3, DMA1_Stream3_IRQHandler)) },
	{ (INHNO_DMA1_STREAM4), (TA_NULL), (FP)(INT_ENTRY(INHNO_DMA1_STREAM4, DMA1_Stream4_IRQHandler)) },
	...
	{ (INHNO_UART9), (TA_NULL), (FP)(INT_ENTRY(INHNO_UART9, UART9_IRQHandler)) },
	...
	{ (INHNO_SPI2), (TA_NULL), (FP)(INT_ENTRY(INHNO_SPI2, SPI2_IRQHandler)) },
	...
	{ (INHNO_EXTI4), (TA_NULL), (FP)(INT_ENTRY(INHNO_EXTI4, EXTI4_IRQHandler)) },
	{ (INHNO_EXTI9_5), (TA_NULL), (FP)(INT_ENTRY(INHNO_EXTI9_5, EXTI9_5_IRQHandler)) }
};

#define TNUM_CFG_INTNO	23
...
const INTINIB _kernel_intinib_table[TNUM_CFG_INTNO] = {
	...
	{ (INTNO_DMA1_STREAM3), (INTATR_DMA1_STREAM3), (INTPRI_DMA1_STREAM3) },
	{ (INTNO_DMA1_STREAM4), (INTATR_DMA1_STREAM4), (INTPRI_DMA1_STREAM4) },
	...
	{ (INTNO_UART9), (TA_NULL|INTATR_UART9), (INTPRI_UART9) },
	{ (INTNO_UART10), (INTATR_UART10), (INTPRI_UART10) },
	{ (INTNO_SPI1), (INTATR_SPI1), (INTPRI_SPI1) },
	{ (INTNO_SPI2), (INTATR_SPI2), (INTPRI_SPI2) },
	...
	{ (INTNO_EXTI4), (INTATR_EXTI4), (INTPRI_EXTI4) },
...
const INIRTNB _kernel_inirtnb_table[TNUM_INIRTN] = {
	{ (INIRTN)(target_hrt_initialize), (EXINF)(0) },
	{ (INIRTN)(newlib_tlsf_init), (EXINF)(0) },
	{ (INIRTN)(tInitializeRoutine_start), (EXINF)(NULL) }
};
...
const TERRTNB _kernel_terrtnb_table[TNUM_TERRTN] = {
	{ (TERRTN)(tTerminateRoutine_start), (EXINF)(NULL) },
	{ (TERRTN)(target_hrt_terminate), (EXINF)(0) }
};
