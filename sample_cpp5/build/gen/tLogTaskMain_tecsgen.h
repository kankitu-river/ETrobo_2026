...
#define tLogTaskMain_cSerialPort_open( ) \
	  tSerialAsyncPortMain_eSerialPort_open( \
	   &tSerialAsyncPortMain_CB_tab[0] )
#define tLogTaskMain_cSerialPort_close( ) \
	  tSerialAsyncPortMain_eSerialPort_close( \
	   &tSerialAsyncPortMain_CB_tab[0] )
#define tLogTaskMain_cSerialPort_read( buffer, length ) \
	  tSerialAsyncPortMain_eSerialPort_read( \
	   &tSerialAsyncPortMain_CB_tab[0], (buffer), (length) )
#define tLogTaskMain_cSerialPort_write( buffer, length ) \
	  tSerialAsyncPortMain_eSerialPort_write( \
	   &tSerialAsyncPortMain_CB_tab[0], (buffer), (length) )
#define tLogTaskMain_cSerialPort_control( ioControl ) \
	  tSerialAsyncPortMain_eSerialPort_control( \
	   &tSerialAsyncPortMain_CB_tab[0], (ioControl) )
#define tLogTaskMain_cSerialPort_refer( pk_rpor ) \
	  tSerialAsyncPortMain_eSerialPort_refer( \
	   &tSerialAsyncPortMain_CB_tab[0], (pk_rpor) )
#define tLogTaskMain_cnSerialPortManage_getChar( p_char ) \
	  tSerialAsyncPortMain_enSerialPortManage_getChar( \
	   &tSerialAsyncPortMain_CB_tab[0], (p_char) )
