...
tSemaphore_INIB tSemaphore_INIB_tab[] = {
    /* cell: tSemaphore_CB_tab[0]:  SerialPortUSB1_ReceiveSemaphore id=1 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        SEMID_tSemaphore_SerialPortUSB1_ReceiveSemaphore, /* id */
    },
    /* cell: tSemaphore_CB_tab[1]:  SerialPortUSB1_SendSemaphore id=2 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        SEMID_tSemaphore_SerialPortUSB1_SendSemaphore, /* id */
    },
    /* cell: tSemaphore_CB_tab[2]:  SerialPortBluetooth1_ReceiveSemaphore id=3 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        SEMID_tSemaphore_SerialPortBluetooth1_ReceiveSemaphore, /* id */
    },
    /* cell: tSemaphore_CB_tab[3]:  SerialPortBluetooth1_SendSemaphore id=4 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        SEMID_tSemaphore_SerialPortBluetooth1_SendSemaphore, /* id */
    },
    /* cell: tSemaphore_CB_tab[4]:  SerialPortTest1_ReceiveSemaphore id=5 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        SEMID_tSemaphore_SerialPortTest1_ReceiveSemaphore, /* id */
    },
    /* cell: tSemaphore_CB_tab[5]:  SerialPortTest1_SendSemaphore id=6 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
